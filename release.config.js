...
module.exports = {
  ...
  plugins: [
    ...
    [
      ...
      {
        publishCmd: `sed -i 's/archive\/v.*\/govbr-ds-dev-core-v.*\.zip/archive\/v${nextRelease.version}\/govbr-ds-dev-core-v${nextRelease.version}\.zip/g' config.json; sed -i 's/\/-\/raw\/v.*\//\/-\/raw\/v${nextRelease.version}\//g' config.json`,
      },
    ],
