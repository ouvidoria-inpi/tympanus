class BRList {
  ...
  _toggle ( event, item ) {
    let icon = item.querySelector(".fa-angle-down") ? item.querySelector(".fa-angle-down") : item.querySelector(".fa-angle-up");
  ...
  _setSelected ( item ) {
    let br_checkbox = item.querySelector(".br-checkbox");
    let br_checkbox_input = br_checkbox.querySelector("input");
