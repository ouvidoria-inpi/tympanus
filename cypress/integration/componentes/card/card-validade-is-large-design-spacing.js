...
const componentClass = '.br-card.is-large'
const fileData = 'card.json';

describe('Validate params of spacing for the component large card', () => {
