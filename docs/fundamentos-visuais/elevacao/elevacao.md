...
*Exemplos de sombras utlizadas no Design System.*
...
No Design System sombras são utilizadas de forma simplificada. Dessa forma, foram criadas _tokens_ de sombras prontas para o uso.
