[Artefato de Design]: # (tipografia_7.0.1.xd)
...
![Lista de Estilo](assets/design-system/docs/fundamentos-visuais/tipografia/imagens/estilo.png)
...
![Escala Tipográfica](assets/design-system/docs/fundamentos-visuais/tipografia/imagens/escala.png)
