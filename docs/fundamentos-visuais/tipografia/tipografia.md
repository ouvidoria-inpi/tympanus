...
No _Design System_ optamos pela fonte base de 14 pixel por considerarmos que esse tamanho seja aplicável na maioria dos dispositivos e situações, porém essa escolha não é definitiva.
...
Existem muitas escalas diferentes, mas dentro do _Design System_ foi escolhida a escala **_Minor Third_** (1,2) já que permitem números que possuem contraste necessário para enriquecer e flexibilizar a hierarquia de uma interface.
