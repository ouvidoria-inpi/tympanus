...
O *template* Erro utiliza a mesma estrutura do "_template_ base", com as seguintes áreas ou regiões: área do *header*, área do conteúdo e área do *footer*, com algumas pequenas modificações:
...
Os textos ficam a critério de cada *site* e podem variar de acordo com a regra de negócio e *layout* mas alguns pontos devem ser ressaltados:
...
Assim como o *header*, é também recomendado que o *footer* esteja na versão compacta e se for necessário pode apresentar *links* para as mídias sociais. Essa é uma boa oportunidade para fortalecer o engajamento do usuário. Assim como foi dito para o _header_, quanto mais simples melhor.
...
- Páginas de erro podem vir a ser o sucesso ou o fracasso da sua experiência com o usuário. Esta pequena, porém importante seção do *design* do *site* tem o potencial de estimular os visitantes a tomar uma ação. Ela pode ser o diferencial entre o visitante desistir e sair do seu _site_ ou tornar-se um cliente leal e grande fã do seu produto.
