...
No Design System usamos o normalize.css customizado. Conheça o normalize.css em <https://necolas.github.io/normalize.css/>.
...
A base do Design System é o Atomic Design.
...
No Design System é usado o linter `stylelint` . Ele pode ser utilizado através do script `npm run lint:styles` .
