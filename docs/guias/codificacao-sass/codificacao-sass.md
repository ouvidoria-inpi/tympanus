Os estilos em CSS no Design System são criados usando o [Sass](https://sass-lang.com/) no formato **scss**.

## Padronização

O Design System usa o [stylelint](https://stylelint.io/) para manter o padrão de escrita Sass.
...
Nas situações onde os estilos precisem sobrescrever scss de vendors em conflito com as configurações do Design System, desabilite temporariamente a regra de acordo com a documentação [Ignoring code](https://stylelint.io/user-guide/ignore-code).
...
Alguns componentes podem ter tokens para facilitar modificações. Eles podem consumir tanto os tokens do Design System quanto seus tokens internos.

No exemplo abaixo existem 6 tokens criados para o componente. Os 2 primeiros consomem tokens de tema do Design System enquanto que os restantes são internos do próprio componente.
