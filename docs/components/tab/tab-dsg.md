...
Sobre o _tooltip_, ver especificações em: (<http://https://www.gov.br/ds/components/tooltip>)
...
Componente padrão. Ver especificações em: (<http://https://www.gov.br/ds/components/divider>)
