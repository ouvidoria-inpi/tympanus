...
Identifica o *site* ou sistema. Seu uso é opcional e pode ser utilizado com o logo, o título ou algum elemento que identifique o _site_ ou o menu.
...
Utilize os ícones Expandir/Retrair para acionar o comportamento *collapse* para acionameto dos subníveis.
...
**Atenção:** tenha em mente que ambos os menus (principal e contextual) funcionam de modo independente. Evite, portanto, dispor *links* comuns nos dois menus. Deixe bem claro para o usuário o nível de navegação que cada menu oferece.

Ver mais detalhes em *Comportamento > Acionamento*.
