...
Abaixo seguem os detalhamentos dos itens do componente _input_. Para maiores informações consulte também a documentação [Padrão de Formulário](https://cdngovbr-ds.estaleiro.serpro.gov.br/padroes/formulario), onde são abordados mais detalhes com relação ao uso do componente _input_ em páginas de formulários.
...
Além disso, o Rótulo também tem a função de indicar ao usuário se o **Campo de Texto é obrigatório ou não**. Veja detalhes sobre a indicação de **Campos Obrigatórios/Opcionais** no documento [Padrão de Formulário](https://cdngovbr-ds.estaleiro.serpro.gov.br/padroes/formulario).
...
Na _grid_ de 4 colunas, recomenda-se que o _Input_ se estenda por toda largura a da tela, proporcionando mais espaço para o usuário digitar o texto solicitado. Também deverá ser utilizado o _input_ com a densidade baixa, com a finalidade de aumentar a área de _touch_. Consulte Comportamento [Densidade](https://cdngovbr-ds.estaleiro.serpro.gov.br/padroes/densidade) para maiores detalhes.
...
Veja mais detalhes sobre máscaras no documento [Padrão de Formulário](https://cdngovbr-ds.estaleiro.serpro.gov.br/padroes/formulario).
