...
![Exemplo de Pagination](imagens/type-default.png) *Exemplo de Pagination*
...
#### 1 - Setas de Navegação (Componente Botão Circular Ênfase Terciária) (Obrigatório)
...
Os *Identificadores de Páginas* também são interativos. O usuário poderá clicar diretamente na página para qual deseja acessar. Neste elemento só será permitido caracteres numéricos. Consulte a seção *Comportamento > Número de Caracteres*, para ver mais detalhes.
...
Consulte mais detalhes em *Comportamentos*. Observe o exemplo abaixo:
