...
| ---------------------------- | :---------------------------: | :----------------: | :------------------: |
| Ícone off (alta)             | <i class="fas fa-times"></i> |  `--icon-size-xs`  |      `fa-times`      |
| Ícone off (média)            | <i class="fas fa-times"></i> |  `--icon-size-sm`  |      `fa-times`      |
| Ícone off (baixa)            | <i class="fas fa-times"></i> | `--icon-size-base` |      `fa-times`      |
| Ícone on (alta)              | <i class="fas fa-check"></i> |  `--icon-size-xs`  |      `fa-check`      |
| Ícone on (média)             | <i class="fas fa-check"></i> |  `--icon-size-sm`  |      `fa-check`      |
| Ícone on (baixa)             | <i class="fas fa-check"></i> | `--icon-size-base` |      `fa-check`      |
