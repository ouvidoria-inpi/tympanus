...
Abaixo segue o detalhamento dos itens do _Componente Textarea_. Para maiores informações consulte também a documentação [Padrão de Formulário](https://cdngovbr-ds.estaleiro.serpro.gov.br/padroes/formulario).
...
Além disso, o _Label_ também tem a função de indicar ao usuário se o **Campo de Texto é obrigatório ou não**. Veja detalhes sobre a indicação de **Campos Obrigatórios/Opcionais** no documento [Padrão de Formulário](https://cdngovbr-ds.estaleiro.serpro.gov.br/padroes/formulario).
...
Para simplificação, utilize o comportamento Estados da mesma forma como é encontrado no [_Input_](https://cdngovbr-ds.estaleiro.serpro.gov.br/components/input) (tanto na parte de uso em fundos claros e escuros como nas suas limitações descritas).
