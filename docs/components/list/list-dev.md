    ...
    <div class="header">
        ...
        <div class="actions">
            <button class="br-button is-circle is-secondary" type="button">
                <i class="fa-lg fas fa-sort-alpha-up"></i>
            </button>
            <div class="divider"></div>
            <button class="br-button is-circle is-secondary" type="button">
                <i class="fa-lg fas fa-search"></i>
            </button>
            <button class="br-button is-circle is-secondary" type="button">
        ...
        <li class="list-item">
            ...
            <div class="icon">
                <a class="list-item" href="#"
                    ><span class="sr-only">Link</span><i class="fas fa-chevron-down"></i
                ></a>
            </div>
        </li>
