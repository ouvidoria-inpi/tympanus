...
Consulte o documento do componente *[Message]( </ds/ds/components>)* para mais detalhes.

### 3- Botões

Botões permitem que o usuário execute algum tipo de ação sobre o formulário.

> No Design System GOV.BR existe o componente [*Button*](/ds/components/button) que pode ser utilizado na maioria das ações dos formulários, e o [*Magic Button*](/ds/components/magicbutton) que pode ser usado para fortalecer o início ou encerramento de fluxos relevante de um formulário.
...
Consulte o documento do [componente *button*](</ds/ds/components/button>) para mais detalhes sobre o seu uso.
...
Utilize a escala de *layout* definida no fundamento [Espaçamento](/ds/fundamentos-visuais/espacamento) para indentar os subagrupamentos. Utilize um valor que fique claro este comportamento tendo como referência o agrupamento que o contêm.
...
Esses espaçamentos devem ser constantes para uma mesma função, em toda a tela e em todo o produto. (Veja mais no fundamento [Espaçamento](/ds/ds/fundamentos-visuais/espacamento).)
