...
### [2.4.4](https://git.serpro.gov.br/dsgov.br/dsgov.br/compare/v2.4.2-changename...v2.4.4-rc.0) (2022-07-01)

### Novidades

* adiciona pagina aderencia-minima ([6f4e603](https://git.serpro.gov.br/dsgov.br/dsgov.br/commit/6f4e6035ddf8a7872f76add50fa409318392d807))

### Correções/Alterações

* ajusta espaçamentos e alinhamentos em padrao-minimo ([d780fad](https://git.serpro.gov.br/dsgov.br/dsgov.br/commit/d780fad7cf1f8f4cd76da68d889bd7e76d130060))
* ajusta pesos de fonte em padrao-minimo ([bab6084](https://git.serpro.gov.br/dsgov.br/dsgov.br/commit/bab6084458c022c29f8e14f1bf11ae67531d437c))
* renomea aderencia-minima para padrao-minimo ([307aea6](https://git.serpro.gov.br/dsgov.br/dsgov.br/commit/307aea67970bf0182a5d2073eb060af6327c6527))
* substitui imagens em padrao-minimo ([9c374b8](https://git.serpro.gov.br/dsgov.br/dsgov.br/commit/9c374b8d676d1a1adb479b3c8bd52d7fc1400caf))

### Documentação

* adiciona a licença para a documentação ([f3b08e1](https://git.serpro.gov.br/dsgov.br/dsgov.br/commit/f3b08e1c1a8459a31f3858828d52ea785b87c5d6))
* adiciona documentos de prototipos ([d33d2af](https://git.serpro.gov.br/dsgov.br/dsgov.br/commit/d33d2afec311e9b43d7ffb8b29d2d29650dfe835))
* altera link do como comecar ([b351848](https://git.serpro.gov.br/dsgov.br/dsgov.br/commit/b3518486d11daec873be7bea276327ceba4be6e3))
* altera o changelog ] ([936ad16](https://git.serpro.gov.br/dsgov.br/dsgov.br/commit/936ad16755c1e06ac74748ac46b3b72d84727d4f))
* atualiza referências para o GOVBR-DS ([d6dea88](https://git.serpro.gov.br/dsgov.br/dsgov.br/commit/d6dea88fb7ec072307860b3ae645a0db846558f0))
* atualiza referências para o GOVBR-DS ([f09241c](https://git.serpro.gov.br/dsgov.br/dsgov.br/commit/f09241cfedc62427e6c6e790f96f3b55e5116963))
* retira referencia governo federal ([b2e3953](https://git.serpro.gov.br/dsgov.br/dsgov.br/commit/b2e3953d2aefd756867d9fdb04990113d016dab2))
...
* correção da execução no npm run start
...
* Trata adaptaçoes para JSON de saida
...
*   Adiciona comportamento de seleção no checkbox e no radio
...
*   Atualiza o template base para a versão 2.1.0
...
*   Elemento texto auxiliar na anatomia.
...
*   Corrigido um título (Canto-Side) que estava com estilo bold.
...
*   Imagem alterada porque usava exemplos de componente tag que estavam desatualizados.
